...
export interface BentoItem {
    ...
    meta?: string;
    cta?: string;
    className?: string; // Replaced colSpan with className
    href?: string;      // Added href for accessibility/links
...
function BentoGrid({ items, className }: BentoGridProps) {
    return (
        <div className={cn("grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 p-4 max-w-7xl mx-auto", className)}>
                ...
                return (
                    <Wrapper
                        ...
                        className={cn(
                            ...
                            "hover:-translate-y-0.5 will-change-transform block",
                            item.className,
                            {
